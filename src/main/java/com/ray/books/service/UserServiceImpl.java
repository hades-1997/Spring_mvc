...
import com.ray.books.dao.RoleDAO;
import com.ray.books.dao.UserDAO;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        com.ray.books.entity.User user = userDAO.findByUserName(username);
        if (user == null)
    ...
    @Override
    @Transactional
    public com.ray.books.entity.User findByUserName(String userName) {
    ...
    public void save(RegisteredUser registeredUser) {
        com.ray.books.entity.User user = new com.ray.books.entity.User();
